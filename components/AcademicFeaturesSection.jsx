  ...
  const features = [
    {
      ...
      description: "Offering a wide range of subjects in Sciences, Arts, and Commerce streams."
    },
    {
      icon: <Users className="h-6 w-6" />,
      title: "Experienced Faculty",
      description: "Learn from highly qualified teachers with years of academic experience."
    },
    {
      icon: <Calendar className="h-6 w-6" />,
      title: "Structured Programs",
      description: "Well-designed academic calendar with regular assessments and feedback."
    },
    {
      icon: <Award className="h-6 w-6" />,
      title: "Academic Excellence",
      description: "Consistent record of outstanding results in board examinations."
    },
    {
      icon: <Clock className="h-6 w-6" />,
      title: "Regular Classes",
      description: "Maintained schedule with timely completion of syllabus and revision."
    },
    {
      ...
      <div className="container px-4 md:px-6">
        ...
        <div className="mx-auto grid max-w-5xl grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-12">
          {features.map((feature, index) => (
            <div key={index} className="flex flex-col items-center space-y-2 border rounded-lg p-6 transition-all hover:shadow-md dark:border-gray-800">

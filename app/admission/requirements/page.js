...
const AdmissionRequirements = () => {
  return (
    <section className="w-full min-h-screen bg-gradient-to-br from-blue-50 via-white to-yellow-50">
      <div className="container mx-auto px-4 py-6 sm:py-8 md:py-12 lg:py-16">
        <div className="max-w-7xl mx-auto">
          {/* Header Section */}
          <div className="text-center mb-8 md:mb-12">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-blue-900 mb-4 leading-tight">
              Admission Requirements
            </h1>
            <div className="inline-block">
              <p className="text-sm sm:text-base md:text-lg font-medium text-red-600 bg-yellow-200 px-3 sm:px-4 py-2 rounded-md shadow-sm">
          ...
          <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="border-l-4 border-red-500 pl-4 bg-red-50 p-3 rounded-r-lg">
                    ...
                    <p className="text-xs text-gray-600">অনলাইন পেমেন্ট</p>
                  </div>
                </div>
              </div>

              {/* Special Offer */}
              <div className="bg-gradient-to-r from-pink-100 to-red-100 rounded-xl p-4 sm:p-6 border border-pink-200">
                <div className="text-center">
                  <Star className="w-8 h-8 text-yellow-500 mx-auto mb-2" />
                  <p className="text-sm sm:text-base font-bold text-red-600 leading-relaxed">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-blue-50 rounded-xl p-4 sm:p-6 border-l-4 border-blue-500">
                <h3 className="font-bold text-blue-800 mb-4 text-base sm:text-lg">
                  আবেদনের সময় প্রয়োজনীয় কাগজপত্র
                </h3>
                <ul className="text-sm space-y-2">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>এসএসসি পরীক্ষার প্রবেশপত্র ও রেজি: কার্ডের কপি</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>এসএসসি পরীক্ষার নম্বরপত্রের প্রিন্টআউট কপি</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>দু'টি মোবাইল নম্বর</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-blue-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>অনলাইন আবেদন ফি ২৩০/- টাকা</span>
                  </li>
                </ul>
              </div>

              <div className="bg-green-50 rounded-xl p-4 sm:p-6 border-l-4 border-green-500">
                <h3 className="font-bold text-green-800 mb-4 text-base sm:text-lg">
                  ভর্তিকালীন প্রয়োজনীয় কাগজপত্র
                </h3>
                <ul className="text-sm space-y-2">
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>মূল ট্রান্সক্রিপ্ট ও ফটোকপি ১ কপি</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>প্রশংসাপত্রের ফটোকপি ১ কপি</span>
                  </li>
                  <li className="flex items-start">
                    <span className="w-2 h-2 bg-green-500 rounded-full mt-2 mr-3 flex-shrink-0"></span>
                    <span>পাসপোর্ট সাইজের ছবি ৩ কপি</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-white rounded-xl shadow-lg p-4 sm:p-6">
                <div className="border-l-4 border-red-500 pl-4 mb-6 bg-red-50 p-3 rounded-r-lg">
                  <h3 className="font-bold text-red-700 mb-2">আবাসিক সুবিধা</h3>
                ...
                <h3 className="font-bold text-blue-700 mb-4 text-base sm:text-lg">
                  বৈশিষ্ট্যসমূহ:
                </h3>
                <ul className="space-y-2">
                  {highlights.map((item, i) => (
                    <li key={i} className="flex items-start gap-2 text-sm">
                      <BadgeCheck className="text-green-600 w-4 h-4 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-gradient-to-r from-blue-600 to-green-600 rounded-xl p-4 sm:p-6 md:p-8 text-white">
              <div className="grid md:grid-cols-2 gap-6 items-center">
                ...
                <div className="text-center md:text-right">
                  <Link
                    href="/admission/form"
                    className="inline-block bg-white text-blue-600 font-bold py-3 px-6 sm:px-8 rounded-lg hover:bg-gray-100 transition-colors duration-200 shadow-lg text-sm sm:text-base"
                  >
                    এখনই আবেদন করুন
                  </Link>
